...
class PGM(Model):
    def __init__(self,
                 ...
                 partition_atol:Optional[float]=1e-20,
                 partition_max_iter:Optional[int]=10000):
    ...
    def sufficient_statistics(self, node):
        return node
    ...
    def node_cond_prob(self,
                       node:int,
                       node_value:int,
                       node_values_suffst:np.ndarray,
